...
# Project information
# ----------------- #
sys.path.append(os.path.abspath('../../mindsdb_evaluator'))

# ----------------- #
# Project information
# ----------------- #
project = 'mindsdb_evaluator'
copyright = '2023, MindsDB'
authors = "MindsDB"
now = datetime.datetime.now()

# Version of the package
packageversion = __import__('mindsdb_evaluator').__version__
...
autoapi_dirs = ['../../mindsdb_evaluator']
